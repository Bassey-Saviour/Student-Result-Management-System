...
(function () {
	...
	// Configuration
	const CGI_SCRIPT_URL = "/cgi-bin/get_all_data.py";
	const CGI_SCRIPT_URL2 = "/cgi-bin/add_data.py";
	const ADMIN_LOGIN_URL = "/cgi-bin/admin_login.py";
	const DELETE_URL = "/cgi-bin/delete_data.py";
	...
	function populateStudents(students) {
        ...
        <td>
          <button class="btn-delete" data-type="student" data-id="${student.student_id}" data-name="${student.first_name} ${student.last_name}">
            <img src="/public/images/icons8-delete.svg"/>
          </button>
        </td>
      `;
		});
